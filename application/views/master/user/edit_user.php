      ...
      <div class="box-body">
        ...
        <form method="post" enctype="multipart/form-data">
          <div class="form-group">
            <input type="hidden" class="form-control <?php echo form_error('user_id') ? 'is-invalid' : '' ?>" type="text" name="user_id" value="<?php echo $users->user_id ?>" />
          </div>
          <div class="form-group">
            <label>Username</label>
            <input class="form-control <?php echo form_error('username') ? 'is-invalid' : '' ?>" type="text" name="iduser" value="<?php echo $user->ID_USER ?>" />
